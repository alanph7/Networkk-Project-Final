          ...
          <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
            <form>
              ...
              <div className="flex flex-col items-center justify-center mb-6">
                <p className="mb-4 text-lg">Sign in with</p>
              ...
              <div className="flex flex-col items-center justify-center mt-6">
                ...
                <p className="mb-0 mt-4 pt-1 text-sm font-semibold">
                  ...
                  <Link to="/seller-signup" className="text-red-600 transition duration-150 ease-in-out hover:text-red-700 focus:text-red-700 active:text-red-800">
                    Register
                  </Link>
                </p>
              </div>
