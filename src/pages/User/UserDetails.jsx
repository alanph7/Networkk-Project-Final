...
export default function UserDetailsForm() {
  ...
  const FormField = ({ label, name, icon: Icon, type = "text", placeholder }) => (
    ...
    <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-lg">
      <div className="px-6 py-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-sky-700 text-white py-3 px-4 rounded-lg hover:bg-indigo-500 transition-colors duration-200 font-medium focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
          >
